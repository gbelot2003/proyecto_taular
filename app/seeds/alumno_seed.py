...
def seed_alumnos():
    ...
    with app.app_context():
        ...
        alumno3 = Alumno(nombre='Carlos', apellido='Rodríguez', email='carlos.rodriguez@example.com', grado=primero)
        alumno4 = Alumno(nombre='Ana', apellido='Martínez', email='ana.martinez@example.com', grado=primero)
